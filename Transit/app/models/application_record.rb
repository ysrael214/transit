  ...
  # This initializes the the functionality of ActiveRecords, which includes Basic CRUD operations, data validation and to relate multiple models with each other
