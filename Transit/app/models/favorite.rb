  ...
  # 2.0 - 1/28/2019 - Sean Ryan Chan - Added specific attributes for the Favorite New Groups on the database
...
class Favorite < ApplicationRecord
  # The following lines of code verify the attributes of the Favorite New Group
  #   It should always have a commuter assigned to it
